				...
				<div class="footer-top">
					...
					<div class="footer-top__other-links">
						<div class="footer-top__other-links_socials">
							...
							<a href="#">
								<img src="<?php echo get_template_directory_uri(); ?>/assets/images/icons/facebook.png" alt="Facebook">
							</a>
							<a href="#">
								<img src="<?php echo get_template_directory_uri(); ?>/assets/images/icons/instagram.png" alt="Instagram">
							</a>
							<a href="#">
								<img src="<?php echo get_template_directory_uri(); ?>/assets/images/icons/telegram.png" alt="Telegram">
							</a>
							<a href="#">
								<img src="<?php echo get_template_directory_uri(); ?>/assets/images/icons/youtube.png" alt="Youtube">
							</a>
							</div>
						</div>
						<div class="footer-top__other-links_payments">
							...
							<a href="#">
								<img src="<?php echo get_template_directory_uri(); ?>/assets/images/logotypes/visa.png" alt="Visa">
							</a>
							<a href="#">
								<img src="<?php echo get_template_directory_uri(); ?>/assets/images/logotypes/paypal.png" alt="Paypal">
							</a>
							<a href="#">
								<img src="<?php echo get_template_directory_uri(); ?>/assets/images/logotypes/mastercard.png" alt="Mastercard">
							</a>
							</div>
						</div>
					</div>
